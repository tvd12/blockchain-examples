			...
			<div class="row">
				<div class="col-lg-12">
					<div class="ibox float-e-margins">
						...
						<div>
							<br />
							<form name="contract" action="deploy-amazing-contract" method="POST">
							  <input type="submit" value="Deploy amazing contract" class="btn btn-success" />
							</form>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<div class="ibox float-e-margins">
						<div class="ibox-title">
							<div class="row m-b-sm m-t-sm">
								<div class="col-md-3">
									<h5>Amazing Contract Address</h5>
								</div>
							</div>
						</div>
						<div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="ibox float-e-margins">
						...
						<div>
							<br />
							<form name="transfer" action="amazing-contract-transfer" method="POST">
